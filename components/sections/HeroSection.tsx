...
import { ShieldCheck, Clock, Star, ArrowRight, CheckCircle2 } from 'lucide-react'
...
export function HeroSection({ onOpenForm }: HeroSectionProps) {
  return (
    <section className="relative pt-[72px] overflow-hidden bg-gradient-to-br from-white via-[#FFF9F2] to-[#FFF4EB]">
      {/* Decorative blobs */}
      <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-[#E87722] opacity-[0.08] blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 -left-32 w-[400px] h-[400px] rounded-full bg-[#C9A96E] opacity-[0.12] blur-3xl pointer-events-none" />
      ...
      <div className="container relative z-10 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            <motion.div variants={fadeUpVariants} className="inline-flex items-center gap-2 mb-6 bg-white shadow-sm border border-[rgba(26,20,16,0.06)] px-4 py-2 rounded-full">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75" />
                <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500" />
              </span>
              <span className="text-[13px] font-medium text-[#1A1410]">Принимаем заявки сегодня</span>
            </motion.div>
            ...
            >
              Ремонт кофемашин<br />
              <span className="bg-gradient-to-r from-[#E87722] to-[#C9A96E] bg-clip-text text-transparent">в Санкт-Петербурге</span>
            </motion.h1>
          ...
          >
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl accent-glow">
              ...
              />
              {/* Floating cards */}
              <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-md rounded-xl p-4 shadow-lg flex items-center gap-3">
              ...
              <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-md rounded-xl p-4 shadow-lg">
            ...
            {/* Stat block */}
            <div className="absolute -bottom-6 -left-6 bg-[#1A1410] text-white rounded-xl p-5 shadow-xl hidden md:block">
              <p className="text-3xl font-semibold tabular text-[#E87722]" style={{ fontFamily: 'var(--font-display)' }}>4 800+</p>
              <p className="text-xs uppercase tracking-wider mt-1 text-[#A8A29A]">кофемашин<br />отремонтировано</p>
            </div>
          </motion.div>
        </div>
      </div>
